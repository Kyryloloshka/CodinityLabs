    ...
    <div class="max-w-[300px] w-full space-y-8">
      <div>
        <div class="mx-auto h-12 w-12 flex items-center justify-center rounded-full bg-theme-tertiary">
          <UIcon name="i-heroicons-user-plus" class="h-8 w-8 text-accent-success" />
        </div>
        ...
        <p class="mt-2 text-center text-sm text-theme-secondary">
          Або
          <NuxtLink to="/login" class="font-medium text-primary hover:text-theme-secondary">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="space-y-4">
          <div>
            <label for="name" class="block text-sm font-medium text-theme-primary">
              Ім'я
            </label>
            <div class="mt-1">
              <input
          ...
          <div>
            <label for="confirmPassword" class="block text-sm font-medium text-theme-primary">
          ...
          <div>
            <label for="role" class="block text-sm font-medium text-theme-primary">
              Роль
            </label>
            <div class="mt-1">
              <select
